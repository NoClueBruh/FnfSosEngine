...
class Character extends FlxSprite
{
	...
	public var camFollowAnimation:Bool = true;
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		script = Modin.instantiateScript(character);
		if(script != null)
		{
			script.variables.set("character", this);
		}
		...
		Modin.runFunctionFromInterp(script,this, "load"); 
		dance();
		...
		Modin.runFunctionFromInterp(script,this, "create"); 
	}
	...
	override function update(elapsed:Float)
	{
		if (!curCharacter.startsWith('bf'))
		{
			...
			if (curCharacter == 'dad')
				dadVar = 6.1;
			if (holdTimer >= (Conductor.stepCrochet * dadVar * 0.001) / (PlayState.instance != null ? PlayState.instance.songAudioSpeed : 1))
			{
				dance();
				holdTimer = 0;
			}
		...
		Modin.runFunctionFromInterp(script, this, "update");
	...
	public function dance()
	{
		...
		Modin.runFunctionFromInterp(script,this, "dance");
	}
